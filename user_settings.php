...
<? header2(1); ?>
<h1 id="title"><? echo _("User Settings"); ?></h1>
...
<form action="do_maint.php?page=user_settings" method="post" name="myuserform" id="myuserform" onsubmit="return validate('user');">
  ...
  <label class="label-n-input"><? echo _("Default Language"); ?>: <select id="mylanguage" name="language" size="1">
    <option value="en_US"<? if($default_lang=="en_US") echo " selected"; ?>><? echo _("English"); ?></option>
    <option value="ja_JP"<? if($default_lang=="ja_JP") echo " selected"; ?>><? echo _("Japanese"); ?></option>
  </select></label>
