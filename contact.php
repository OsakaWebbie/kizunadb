...
<?php header2(1); ?>
<h1 id="title"><?=_("Contact List").(isset($_POST['pid_list']) ? sprintf(_(" (%d People/Orgs Pre-selected)"),
substr_count($_POST['pid_list'],",")+1) : "")?></h1>

<form id="cform" method="post" action="blank.php" target="ResultFrame">
  ...
  <div class="section">
    <div id="listtypes">
      ...
      <label class="label-n-input"><input type="radio" name="listtype" value="ContactType"><?=_("Group by Contact Type")?></label>
...
?>
    ...
    <input type="button" id="show_contacts" name="show_contacts" value="<?=_("Show List")?>">
  </div>
