...
//alert("testing field"+index+": "+form.elements['field'+index].value);
    if (form.elements["field"+index].value == "category") {
      fieldnumlist = fieldnumlist + index;
//alert("testing cat"+index+": "+form.elements["cat"+index].value);
      if (form.elements["cat"+index].value == "") {
//alert("I think it's blank, so setting flag");
        need_popup = 1;
      }
    }
  }
